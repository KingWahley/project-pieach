        ...
        <AnimatePresence mode="popLayout">
          ...
          >
            <img
              ...
              alt=""
              className="h-full w-full object-cover blur-3xl saturate-200 opacity-50"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#f4f4f4] via-[#f4f4f4]/50 to-transparent" />
          </motion.div>
        </AnimatePresence>
      </div>
        ...
        <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1 rounded-full bg-white/80 p-1 ring-1 ring-black/5 backdrop-blur-md">
              <button
                onClick={handlePrev}
                className="rounded-full p-3 text-neutral-600 transition hover:bg-black/5 hover:text-black active:scale-95"
                aria-label="Previous"
              >
